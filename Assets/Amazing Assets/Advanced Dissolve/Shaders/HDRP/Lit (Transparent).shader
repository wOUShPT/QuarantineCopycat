...
#include "Assets/Amazing Assets/Advanced Dissolve/Shaders/cginc/Core.cginc"
                    ...
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
    {
        ...
        float _Split_A921077C_R_1 = _Multiply_141A51E_Out_2[0];
        float _Split_A921077C_G_2 = _Multiply_141A51E_Out_2[1];
        float _Split_A921077C_B_3 = _Multiply_141A51E_Out_2[2];
        float _Split_A921077C_A_4 = _Multiply_141A51E_Out_2[3];
        ...
        surface.Alpha = _Split_A921077C_A_4;
        surface.AlphaClipThreshold = _AdvancedDissolve_ED28DB36_Out_3;
