...
Shader "Amazing Assets/Advanced Dissolve/TextMeshPro/Mobile/Distance Field - Masking" {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		pixel_t VertShader(vertex_t input)
		{
			...
			output.mask = half4(vert.xy * 2 - clampedRect.xy - clampedRect.zw, 0.25 / (0.25 * half2(_MaskSoftnessX, _MaskSoftnessY) + pixelSize.xy));
				...
				output.underlayParam.xy = half2(layerScale, layerBias);
			#endif
			


			//Advanced Dissolve 
			output.underlayParam.zw = TRANSFORM_TEX(UnpackUV(input.texcoord1), _MainTex);

			output.positionOS = input.vertex;
			output.normalOS = input.normal;

			ADVANCED_DISSOLVE_INIT_UV(output, input.texcoord0, vPosition)
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	ADVANCED_DISSOLVE_SETUP_CUTOUT_SOURCE_USING_OS(input, c, input.positionOS, input.normalOS)
	AdvancedDissolveCalculateAlphaAndClip(cutoutSource.a, c.a, cutout);

	float3 dissolveAlbedo = 0;
	float3 dissolveEmission = 0;
	float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, c, dissolveAlbedo, dissolveEmission, input.underlayParam.zw);

	c.rgb = lerp(c.rgb, dissolveAlbedo, dissolveBlend);
	c.rgb += lerp(0, dissolveEmission, dissolveBlend);
...
CustomEditor "TMPro.EditorUtilities.AdvancedDissolve_TMP_SDFShaderGUI"
}
