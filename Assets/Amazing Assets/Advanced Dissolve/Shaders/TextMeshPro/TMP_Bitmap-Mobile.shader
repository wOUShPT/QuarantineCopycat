Shader "Amazing Assets/Advanced Dissolve/TextMeshPro/Mobile/Bitmap" {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		v2f vert (appdata_t v)
		{
			...
			//Advanced Dissolve 
			OUT.texcoord0.zw = TRANSFORM_TEX(UnpackUV(v.texcoord1), _MainTex);

			OUT.positionOS = v.vertex;
			OUT.normalOS = v.normal;

			ADVANCED_DISSOLVE_INIT_UV(OUT, v.texcoord0, OUT.vertex)
		...
		fixed4 frag (v2f IN) : COLOR
		{
			...
			//return float4(IN.texcoord0.zw, 0, 1);
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, color, dissolveAlbedo, dissolveEmission, IN.texcoord0.zw);
