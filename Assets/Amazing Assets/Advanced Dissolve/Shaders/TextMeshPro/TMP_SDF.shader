Shader "Amazing Assets/Advanced Dissolve/TextMeshPro/Distance Field" {
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	ADVANCED_DISSOLVE_SETUP_CUTOUT_SOURCE_USING_OS(input, faceColor, input.positionOS, input.normalOS)
	AdvancedDissolveCalculateAlphaAndClip(cutoutSource.a, faceColor.a, cutout);

	float3 dissolveAlbedo = 0;
	float3 dissolveEmission = 0;
	float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, faceColor, dissolveAlbedo, dissolveEmission, input.textures.xy);

	faceColor.rgb = lerp(faceColor.rgb, dissolveAlbedo, dissolveBlend);
	faceColor.rgb += lerp(0, dissolveEmission, dissolveBlend);
...
Fallback "Amazing Assets/Advanced Dissolve/TextMeshPro/Mobile/Distance Field"
